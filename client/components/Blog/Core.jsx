...
const Blog = () => {
  return (
    <section className="mt-20 mb-80 w-full flex  lg:ml-[140px] justify-center lg:justify-start">
      <div className="relative w-[320px] sm:w-[640px] md:w-[800px] lg:w-[1080px] xl:w-[1300px] h-[520px] rounded-[10px] bg-primary pl-[34px] pt-10 pb-10 lg:pl-20 lg:pt-20 lg:pb-20">
        <h3 className="font-bold text-[32px] lg:text-[48px] text-white">
          good things
        </h3>
